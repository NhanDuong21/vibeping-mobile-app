...
- Khi quá hai phút không có tín hiệu, trạng thái chuyển thành “Chưa rõ trạng thái Codex”, không tự báo hoàn tất. Giao diện ngừng chuyển động trong tối đa một nhịp cập nhật 30 giây; mở lại ứng dụng kiểm tra ngay và đồng bộ với laptop.
...
- Ứng dụng kiểm tra cập nhật khi mở, trở lại từ nền, có mạng và mỗi phút khi đang mở. Chỉ mời cập nhật khi toàn bộ bản mới đã tải xong, có số phiên bản; không tự tải lại khi bạn đang xem.

## Dữ liệu và tương thích

Nâng cấp cấu trúc dữ liệu 0009 phục hồi bằng chứng bắt đầu từ lịch sử đã lưu. Các bản ghi cũ không đủ bằng chứng được loại khỏi công việc hiện tại; lịch sử và thông báo không bị xóa, không tạo sự kiện hoàn tất giả. Có sao lưu dữ liệu trước nâng cấp cấu trúc dữ liệu. Nếu phục hồi RC1, phải phục hồi cả bản sao dữ liệu trước nâng cấp cấu trúc dữ liệu.
...
Giữ laptop bật VibePing và Tailscale kết nối. Mở VibePing từ màn hình chính, đóng rồi mở lại nếu đang giữ bản cũ; khi xuất hiện “Có bản VibePing mới”, bấm “Cập nhật”. Lần nâng từ RC1 có thể cần mở lại ứng dụng để bộ lưu ngoại tuyến kiểm tra bản mới. Không xóa dữ liệu Safari hoặc gỡ ứng dụng; thao tác đó có thể làm mất ghép nối và đăng ký thông báo.

Không thay địa chỉ riêng, không bật Funnel, không thêm tự khởi động. Bản phát hành vẫn là RC: kiểm thử trình duyệt không thay thế kiểm chứng cập nhật và thông báo trên iPhone thật.

## Kiểm chứng phát hành

- 100 kiểm thử Rust, 52 kiểm thử Angular, 6 kiểm thử nền PWA và 68 kiểm thử Playwright đạt; bổ sung kiểm thử nâng cấp cấu trúc dữ liệu RC1, tín hiệu đến muộn, mất tín hiệu, phản hồi tải lại sai thứ tự và dừng khi kết nối trực tiếp còn mở.
- Đã chạy kiểm tra định dạng, lint, kiểu dữ liệu, hợp đồng API, Tailwind, kiến trúc, vệ sinh kho mã, nội dung tiếng Việt và biên dịch bản phát hành.
...
- Biên dịch vẫn có cảnh báo kích thước gói khởi đầu 494,09 kB so với mức cảnh báo 491 kB, dưới mức chặn 700 kB. Không nới ngưỡng kiểm tra để bỏ qua cảnh báo.
