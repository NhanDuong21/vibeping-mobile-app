...
- Ba vạch xanh bạc hà chuyển động cạnh **Đang làm việc**, theo đúng phiên đang mở và tín hiệu mới nhận.
- Khi Codex chờ bạn, hoàn tất, dừng hoặc khi mất kết nối hay tín hiệu đã cũ, dấu chuyển động biến mất.
- Chuyển động dừng khi rời màn hình hoặc ẩn ứng dụng. Chế độ Vừa phải, Tối giản và Giảm chuyển động giữ dấu tĩnh.
- Giữ nguyên diễn biến, kết quả cuối Codex, hồ sơ dự án, thông báo cá nhân và Sẵn sàng trên Windows.
...
Gói Windows x64 đi kèm tệp SHA-256. Đã kiểm thử tự động trạng thái phiên, chế độ chuyển động, giao diện sáng/tối và cập nhật PWA giữ dữ liệu. Hiển thị trên iPhone thật vẫn cần xác nhận khi sử dụng.
