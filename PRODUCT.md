...
- In 1.3, one Codex thread is one Công việc in Activity. Prompts are Yêu cầu, expanded inline in work detail with their own real timelines, observed durations, read states and retained results. The latest opens automatically; a single request has no hierarchy labels. Idle status is compact and full technical results stay in detail. Distinct threads never merge by project. Historical data never gains invented stages, titles or start times.
